...
<template>
  <div class="box">
    <div class="top">
      <img src="@/assets/imgs/dataV/jhListTitle.png" alt="" />
    </div>
    <div class="topName">
    ...
    <div class="guding" ref="boxRef">
      <div class="bottom-top">
        <div class="bottom-top-one">排名</div>
        <div class="bottom-top-two">拣货员</div>
    ...
    <div class="bottom" ref="rankScrollRef">
      <div class="scroll-content">
        <div class="list-item" v-for="(item, index) in list" :key="index">
          ...
          <div class="list-item-two">{{ item.pickingStaff }}</div>
...
const init = async () => {
  ...
  const res = await warehouseLargeScreen.pickingRank(params)
  list.value = res
  if (list.value.length >= 5) {
    list.value = [...list.value, {}]
  }
  No1.value = res[0].pickingStaff || ''
  No2.value = res[1].pickingStaff || ''
  No3.value = res[2].pickingStaff || ''
}
// 每隔10分钟请求一次接口
