<!-- 打包排行榜 毛天 2025年3月11日10:47:43 -->
<template>
  <div class="box">
    <div class="top">
      <!-- <div class="top-iocn"></div>
      打包排行榜 -->
      <img src="@/assets/imgs/dataV/dbListTitle.png" alt="" />
    </div>
    <div class="topName">
    ...
    <div class="guding">
      <div class="bottom-top">
        ...
        <div class="bottom-top-two">打包员</div>
    ...
    <div class="bottom" ref="rankScrollRef">
      <div class="scroll-content">
        <div class="list-item" v-for="(item, index) in list" :key="index">
          ...
          <div class="list-item-two">{{ item.packager }}</div>
...
const init = async () => {
  ...
  const res = await warehouseLargeScreen.packingRank(params)
  list.value = res
  if (list.value.length >= 5) {
    list.value = [...list.value, {}]
  }
  No1.value = res[0].packager || ''
  No2.value = res[1].packager || ''
  No3.value = res[2].packager || ''
}
// 每隔10分钟请求一次接口
