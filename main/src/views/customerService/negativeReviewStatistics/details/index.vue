<template>
  <scheme-details ref="detailsRef" name="Negativereviewstatistics">
    <template #card>
...
<script lang="tsx">
export default { name: 'NegativereviewstatisticsDetails' };
</script>
...
const { onSearch } = inject(`NegativereviewstatisticsForm`) as FromProvideType;
...
provide('NegativereviewstatisticsDetails', { dataValue, bukValue, viewType, title });
