...
export class SearchItem {
  qualityInspectionType: Array<number> = []
...
export const statusOptions: Array<any> = [
  // { label: '暂存', value: 1, color: '#5DB300', txt: '#fff' },
...
export interface TabsProvideType {
  ...
  getList: (id?: string) => Promise<void> | void
  handleAdd: () => void
  isCreater: Ref<boolean>
  tabsInit: () => void
