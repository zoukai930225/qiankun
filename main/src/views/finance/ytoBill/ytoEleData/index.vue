<template>
  <ContentWrap>
      ...
      <div class="commonTopFilterWrap">
        <div class="commonTopFilterWrap-filter">
          <el-form ref="queryFormRef" :inline="true" :model="queryParams" label-width="66px">
            ...
            <el-form-item label="匹配圆通" class="each-form" prop="isMatch">
    ...
    <el-table :header-cell-style="appStore.headerCellStyle" v-loading="loading" :data="list"
      ...
      border stripe :tooltip-options="{ popperClass: 'refund-tips' }">
      ...
      <el-table-column label="网点名称(PDD,千牛)" prop="branchName" min-width="160"
      ...
      <el-table-column label="是否匹配圆通" prop="isMatchZto" min-width="180"
    ...
    <matchDrawer ref="matchDrawerRef" billMatchType="YTO" billMatchTypeName="圆通"/>
    <downloadDrawer ref="downloadDrawerRef" :bizType="4" border stripe/>
  </ContentWrap>
...
import { channelList, getChannelIcon, getLabelByValue } from '@/views/finance/ztoEleData/common'
import { formatterValue, formatTime } from "@/utils";
import * as ztoEleDataApi from '@/api/finance/billMatch'
import { useAppStore } from '@/store/modules/app'
const appStore = useAppStore()
import matchDrawer from '@/views/finance/ztoEleData/components/matchDrawer.vue';
