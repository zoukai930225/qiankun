  ...
  <div class="node">
    ...
    >
      <template #default="{ item, index, active }">
        <div :style="index > 0 ? 'padding-top: 8px' : ''">
          <nodeItem :key="index" :data="item" :nodeCode="data.nodeCode" @click-node="clickNode" />
        </div>
      </template>
    </DynamicScroll>
    <!-- <ElScrollbar
    ...
    >
      <div
        :class="['node-center', isBigScreen ? 'bigScreen' : '']"
...
.node {
  ...
  &-center {
    ...
    min-height: calc(100vh - 225px - 150px);
    &.bigScreen {
