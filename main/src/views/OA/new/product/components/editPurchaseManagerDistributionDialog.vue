...
const getDesignDetail = async () => {
  ...
  form.procurementManagerId = res.procurementManagerId || ''
  if (
    res.procurementManagerIdList &&
    typeof res.procurementManagerIdList === 'string' &&
    res.procurementManagerIdList !== ''
  ) {
    form.procurementManagerIdList = JSON.parse(res.procurementManagerIdList)
  } else {
    form.procurementManagerIdList = res.procurementManagerIdList || []
  }
}
