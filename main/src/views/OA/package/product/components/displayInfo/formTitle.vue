  ...
  <div>
    <div class="title row-center" :style="{ marginBottom: mbStyle, marginTop: mtStyle }">
      <div class="row-center" style="padding: 1px 0; box-sizing: border-box">
        <div style="width: 3px; height: 12px; background: #0064ff; margin-right: 5px"></div>
        <div style="padding: 1px 0; box-sizing: border-box">{{ title }}</div>
      </div>
      <div class="row-center right-wapper" @click="toggleExpand" v-if="showcollapse">
        ...
        <div>
          ...
          <img
            src="@/assets/imgs/common/xiangshang-activity.png"
            alt=""
            class="icon"
            v-if="!isExpanded"
          />
          <img
            src="@/assets/imgs/common/xiangxia-activity.png"
            alt=""
            class="icon"
            v-if="isExpanded"
          />
