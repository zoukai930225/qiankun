...
// 新增
const handleAdd = () => {
  competiorAddDialogRef.value.open(null, props.currentId)
}
...
// 列表
const getList = async () => {
  const res = await getCompetorsList({ ...params.value, devPlanId: props.currentId })
...
const handleEdit = (row: any) => {
  competiorAddDialogRef.value.open(row, props.currentId)
}
// 删除
