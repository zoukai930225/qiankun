...
<template>
  <div v-if="visible">
    <el-dialog v-model="visible" :width="width" :before-close="handleClose" @open="resetForm"
      ...
      <div v-loading="loading" element-loading-text="正在回收,请稍候...">
        <div class="dialog-content" style="width: 456px; height: 252px; overflow: hidden">
          <el-form ref="ruleFormRef" :model="form" label-width="auto"
            ...
            <el-form-item label="回收原因：" prop="examineRemark">
              <s-text-area style="width: 294px" v-model="form.examineRemark" placeholder="请输入回收原因" :rows="4"
