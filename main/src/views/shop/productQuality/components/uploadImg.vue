...
<template>
  <div class="upload-img-wapper">
    ...
    >
      <template #default>
        <div class="upload-cus" v-loading="uploadImg" v-if="uploadType == 'product'">
          <img src="@/assets/imgs/team/add-default-img.png" class="add-default-img" />
          <span class="upload-cus-title">添加产品图</span></div
        >
        <div class="upload-cus" v-loading="uploadImg" v-else-if="uploadType == 'attachment'">
          <img src="@/assets/imgs/common/upload.png" class="add-default-img" />
          <span class="upload-cus-title">添加附件</span></div
        >
      </template>
