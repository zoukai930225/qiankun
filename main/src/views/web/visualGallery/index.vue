<template>
  <div
    ...
    :style="fatherStyle"
  >
    <Title v-if="isNotSync" ref="titleRef" @update-time-select="updateTimeSelect" />
    <div class="content">
      <div class="button">
        ...
        <!-- <div @click="openPromoteImgs" class="tisheng"> 待提升车图库 </div> -->
        <!-- <div @click="openHighQualityImgs" class="tisheng good"> 优质车图库 </div> -->
      ...
      <div class="picList">
        ...
        <galleryList :list="list" :total="total" @get-list="changeGetList" />
        <!-- 空页面 -->
        <img
          v-if="total === 0"
          style="
...
import SWSelectPeople from './components/SWSelectPeople.vue'
...
function onQuality() {
  openDialog({
    ...
    width: '1470px',
    top: '3.5vh',
    content: defineAsyncComponent(() => import('./components/dir/gallery/index.vue')),
    props: {
      dirs: primaryDirs,
      isGood: '1'
    },
...
async function openCollection(type: 1 | 2, title: string) {
  try {
    ...
    openDialog({
      ...
      width: '1482px',
      top: '3.5vh',
      content: defineAsyncComponent(() => import('./components/dir/collection/index.vue')),
      props: {
        dirs,
        type
      },
