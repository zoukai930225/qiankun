...
export const useMessage = () => {
  ...
  return {
    ...
    // 确认窗体
    confirm(content: string, tip?: string, center = true) {
      return ElMessageBox.confirm(content, tip ? tip : t('common.confirmTitle'), {
        confirmButtonText: t('common.ok'),
        cancelButtonText: t('common.cancel'),
        type: 'warning',
        showClose: center ? false : true,
        center: center,
        cancelButtonClass: 'cancelbth',
        confirmButtonClass: 'yepbth',
        customClass: center ? 'custom_class_confirm' : '',
        closeOnClickModal: false
      })
    },
    // 删除窗体
    delConfirm(content?: string, tip?: string, center = true) {
    ...
    // 导出窗体
    exportConfirm(content?: string, tip?: string, center = true) {
      return ElMessageBox.confirm(
