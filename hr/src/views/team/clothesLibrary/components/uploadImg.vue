<template>
  <div class="upload-box" :style="{ width: width, height: height }">
    <el-upload
      ...
      :multiple="false"
      name="files"
      :data="{ code: 'SHOOTING_CLOTHING_WAREHOUSE', businessForeignKey: uuid }"
    ...
    >
      <template v-if="modelValue">
        <img :src="modelValue" class="upload-image" :style="{ width: width, height: height }" />
        <div class="upload-handle" @click.stop>
          <!-- <div class="handle-icon" @click="editImg" v-if="!disabled && showEdit">
            <Icon icon="ep:edit" />
        ...
        <div class="upload-empty">
          <slot name="empty">
            <div class="upload-cus">
              <img src="@/assets/imgs/team/empty_upload.png" class="add-default-img" />
              <span class="upload-cus-title">{{ uploadText }}</span></div
            >
          </slot>
        </div>
      </template>
...
const uploadSuccess: UploadProps['onSuccess'] = (res: any): void => {
  ...
  emit('update:modelValue', res.data[0].fileUrl)
}
