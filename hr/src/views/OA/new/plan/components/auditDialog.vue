    ...
    <el-dialog v-model="visible" :width="width" :before-close="handleClose" @open="resetForm"
          ...
          <el-form ref="ruleFormRef" :model="form" label-width="auto"
            ...
            <el-form-item label="是否通过审核：" prop="status">
              <el-radio-group v-model="form.status">
                ...
                <el-radio value="2" style="width: 100%; font-size: 16px"> 审核拒绝</el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item v-if="form.status === '2'" label="备注：" prop="examineRemark">
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button type="primary" @click="confirmDialog" :loading="loading">提交</el-button>
        </div>
      </template>
    </el-dialog>
  </div>
