<template>
  <scheme-details ref="detailsRef" name="Newplan">
    <template #card>
...
<script lang="tsx">
export default { name: 'NewplanDetails' };
</script>
...
const { onSearch } = inject(`NewplanForm`) as FromProvideType;
...
provide('NewplanDetails', { dataValue, bukValue, viewType, title });
