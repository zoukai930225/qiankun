<template>
  <div class="suppierLeft">
    ...
    <TextInfo title="店铺" :content="data && data.store" />
    ...
    <TextInfo title="企划时间" :is-time="true" :content="data && data.planningTime" />
    <TextInfo title="预计拍摄日期" :is-time="true" :content="data && data.estimatedShootingDate" />
    <TextInfo title="计划下单日期" :is-time="true" :content="data && data.planOrderDate" />
...
import FileItem from '@/views/OA/new/product/components/displayInfo/fileItem.vue'
