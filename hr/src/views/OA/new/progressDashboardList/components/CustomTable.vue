  ...
  <div>
    ...
    >
      ...
      <el-table-column label="企划阶段" align="center" width="180">
        <el-table-column label="企划名称" prop="planName" width="200" align="center" />
        <el-table-column label="企划类型" prop="planType" width="120" align="center">
          <template #default="{ row }">
            <div class="center"> <PlanType :planType="row.planType" /></div>
          </template>
        </el-table-column>
        <el-table-column label="店铺" prop="store" width="200" align="center">
          <template #default="{ row }">
        ...
        <el-table-column label="产品等级" prop="isCore" width="120" align="center" />
        <el-table-column label="计划下单日期" prop="planOrderDate" width="120" align="center">
          <template #default="{ row }">
            {{ row.planOrderDate }}
          </template>
        </el-table-column>
        <el-table-column label="计划上架日期" prop="planListStartDate" width="120" align="center">
          <template #default="{ row }">
            {{ row.planListDate }}
          </template>
        </el-table-column>
        <el-table-column label="品类" prop="category" width="120" align="center">
          <template #default="{ row }">
            <div class="disableValue">{{ formatCategory(row.category) || '--' }}</div>
          </template>
        </el-table-column>
        <el-table-column label="系列" prop="classCode" width="100" align="center" />
        <el-table-column label="类型" prop="productType" width="80" align="center">
          <template #default="{ row }">
            {{ row.productType == '0' ? '买手款' : row.productType == '1' ? '定制款' : '--' }}
          </template>
        </el-table-column>
        <el-table-column label="卖点" prop="salePoint" width="150" align="center">
          <template #default="{ row }">
      ...
      <el-table-column label="打样阶段" align="center" width="240">
        <el-table-column label="设计师" prop="designer" width="140" align="center">
          <template #default="{ row }">
            <el-avatar :src="row.designerAvatar" v-if="row.designerAvatar" class="avatar" />
            <span class="avatar-name">{{ row.designerName }}</span>
          </template>
        </el-table-column>
        <el-table-column label="设计图" prop="designImage" width="120" align="center">
          <template #default="{ row }">
            <el-image
        ...
        <el-table-column label="供应链开发" width="200">
          <template #default="{ row }">
        ...
        <el-table-column label="打样进度" prop="sampleProgress" width="120" align="center">
          <template #default="{ row }">
            <div class="flex-row">
        ...
        <el-table-column label="选品理由" prop="selectionReason" width="120" align="center">
          <template #default="{ row }">
            {{ row.chooseReason || '' }}
          </template>
        </el-table-column>
      ...
      <el-table-column label="产品阶段" align="center" width="320">
        <el-table-column label="当前节点" prop="currentNodeName" width="130" align="center" />

        <el-table-column label="货品编码" prop="productCode" width="100" align="center" />
        <el-table-column label="供应商" prop="supplier" width="130" align="center">
          <template #default="{ row }">
            {{ row.supplierName }}
          </template>
        </el-table-column>
        ...
        <el-table-column label="裸货价" prop="productCostExcludingTax" width="100" align="center">
          <template #default="{ row }">
            <span v-if="row.productCostExcludingTax">{{ row.productCostExcludingTax }}/元</span>
          </template>
        </el-table-column>
        <el-table-column label="包装人工费" prop="packagingManpowerNew" width="100" align="center">
          <template #default="{ row }">
            <span v-if="row.packagingManpowerNew">{{ row.packagingManpowerNew }}/元</span>
          </template>
        </el-table-column>
        <el-table-column label="成品价" prop="finishedProductPrice" width="100" align="center">
          <template #default="{ row }">
            <span v-if="row.finishedProductPrice">{{ row.finishedProductPrice }}/件</span>
          </template>
        </el-table-column>
        <el-table-column label="齐色样" prop="goodsCode" width="120" align="center">
          <template #default="{ row }">
            <el-image
        ...
        <el-table-column label="运营" prop="goodsCode" width="140" align="center">
          <template #default="{ row }">
            <el-avatar
              :src="row.operateManageAvatar"
              v-if="row.operateManageAvatar"
              class="avatar"
            />
            <span class="avatar-name">{{ row.operateManageName }}</span>
          </template>
        </el-table-column>
        <el-table-column label="面料成分/补充" prop="component" width="150" align="center" />
        <el-table-column label="售价" prop="price" width="100" align="center" />
        <el-table-column label="产前样进度" prop="goodsCode" width="100" align="center">
          <template #default="{ row }">
        ...
        <el-table-column label="采购" prop="goodsCode" width="140" align="center">
          <template #default="{ row }">
            <el-avatar
              :src="row.procurementManagerAvatar"
              v-if="row.procurementManagerAvatar"
              class="avatar"
            />
            <span class="avatar-name">{{ row.procurementManagerName }}</span>
          </template>
        </el-table-column>
      </el-table-column>
...
const mergeFields = ['planName', 'planType', 'store', 'isCore', 'planListStartDate']
