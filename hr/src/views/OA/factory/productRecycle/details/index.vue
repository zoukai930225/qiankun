<template>
  <scheme-details ref="detailsRef" name="Factoryproductrecycle">
    <template #card>
...
<script lang="tsx">
export default { name: 'FactoryproductrecycleDetails' };
</script>
...
const { onSearch } = inject(`FactoryproductrecycleForm`) as FromProvideType;
...
provide('FactoryproductrecycleDetails', { dataValue, bukValue, viewType, title });
