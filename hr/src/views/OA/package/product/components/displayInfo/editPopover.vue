    ...
    <div class="edit-popover" v-if="visible">
      ...
      <div class="pop-content">
        ...
        <div v-else-if="keyCode === 'isSyncWdt'">
          <el-select
            class="topHeader-search-store"
            v-model="designDetailView[keyCode]"
            placeholder="请选择"
            clearable
          >
            <el-option
          ...
          <div v-for="(field, index) in filterField(keyCode)" :key="index">
            ...
            <el-form :model="designDetailView" ref="formRef" @submit.prevent="handleSave">
              <el-form-item label="" :prop="field.code">
                <!--颜色 -->
                <div
                  class="row dialogFormItemWidth"
                  style="width: 350px"
                  v-if="field.code === 'color'"
                >
                  <el-select
                    :style="{ width: '185px' }"
                    v-model="designDetailView[field.code]"
                    placeholder="请选择颜色"
                    multiple
                    clearable
                  >
                ...
                <div v-if="field.code === 'component'" style="min-width: 250px; max-width: 250px">
                  <FabricComposition
                    :list="
                      (designDetailView.component && designDetailView.component.split(',')) || []
                    "
      ...
      <div class="btn-group">
        ...
        <el-button class="btn" type="primary" @click="handleSave" :loading="submitLoading"
          >提交</el-button
        >
      </div>
