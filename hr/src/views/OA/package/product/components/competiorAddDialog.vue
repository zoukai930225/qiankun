          ...
          <div class="flex-row form-wapper" style="margin-left: 0px">
            <el-form ref="formRef" :model="localForm" :rules="formRules" label-width="80px">
              <div style="display: flex; flex-wrap: wrap">
                ...
                <el-form-item label="销量" class="formItem" style="width: 280px" prop="salesVolume">
                  <el-input v-model="localForm.salesVolume" placeholder="请输入销量" />
                </el-form-item>
                <el-form-item label="客单价" class="formItem" style="width: 280px" prop="customerUnitPrice">
                ...
                <el-form-item label="图片" class="formItem" prop="imgUrl">
                  <UploadImg width="146px" height="146px" :showEdit="false"
                    :bussiness-code="UPLOAD_FILE_BISSONESSCODE.NEW_PRODUCT" v-model:modelValue="localForm.imgUrl" />
                </el-form-item>
              </div>
            </el-form>
          </div>
...
import { updateDesign, saveDesign } from '@/api/oa/new/designGallery/index'
...
const titleLbl = ref('')
// 打开
const open = async (data: any, npDevelopmentPlanId: any) => {
  visible.value = true
  nodeData.value = data
  localForm.value = {
    npDevelopmentPlanId,
  ...
  if (data) {
    ...
    localForm.value.npDevelopmentPlanId = npDevelopmentPlanId || ''
  } else {
