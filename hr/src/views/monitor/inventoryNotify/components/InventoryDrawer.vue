      ...
      <el-form label-position="right" label-width="110px" :model="formData">
        <div class="drawerContent">
          <el-form-item label="商家编码">
            <el-input v-model="formData.skuCode" readonly />
          </el-form-item>
          <el-form-item label="商品名称">
            <el-input v-model="formData.productName" readonly />
          </el-form-item>
          <el-form-item label="规格">
            <el-input v-model="specification" readonly />
          </el-form-item>
          <el-form-item label="七天销量">
            <el-input v-model="formData.salesSevenDays" readonly />
          </el-form-item>
          <el-form-item label="库存">
            <el-input v-model="formData.stock" readonly />
          </el-form-item>
          <el-form-item label="告警日期">
            <el-input v-model="formData.alarmTime" readonly />
          </el-form-item>
          <el-form-item label="运营人员">
            <el-input v-model="formData.responsibilityPersonName" readonly />
          </el-form-item>
          <el-form-item label="处理人">
            <el-input v-model="formData.processorName" readonly />
          </el-form-item>
          <el-form-item label="处理时间">
            <el-input v-model="formData.processCompletionTime" readonly />
          </el-form-item>
          ...
          <el-form-item v-if="fileName" label="附件">
            <el-link
              :underline="false"
              type="primary"
              @click="downloadByUrl2(formData.attachmentUrl, fileName)"
              >{{ fileName }}</el-link
            >
          </el-form-item>
        </div>
...
const specification = computed({
  get: () =>
    `${formData.value.category}-${formData.value.specificationCode}-${formData.value.specificationName}`,
  set: () => {}
})
</script>
