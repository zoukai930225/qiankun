...
const setChartOptions = () => {
  ...
  let tooltip = {
    ...
    formatter: function (param) {
      if (param.length > 1) {
        return (
          '<div style="min-width: 130px; padding-right: 8px;height: 70px;background: #ffffff;border-radius: 4px;display: flex;flex-direction: column;margin:-4px; ">' +
        ...
        return (
          '<div style="min-width: 130px; padding-right: 8px;height: 50px;background: #ffffff;border-radius: 4px;display: flex;flex-direction: column;margin:-4px; ">' +
          `<div style="display: flex;flex-direction: row;align-items: center;padding-top: 4px;margin-left:6px;font-size: 14px;color: #8186A5;">` +
          '<div>' +
          `${param[0].axisValue}` +
          '</div>' +
