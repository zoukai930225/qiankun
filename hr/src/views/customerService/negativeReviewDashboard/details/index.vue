<template>
  <scheme-details ref="detailsRef" name="Negativereviewdashboard">
    <template #card>
...
<script lang="tsx">
export default { name: 'NegativereviewdashboardDetails' };
</script>
...
const { onSearch } = inject(`NegativereviewdashboardForm`) as FromProvideType;
...
provide('NegativereviewdashboardDetails', { dataValue, bukValue, viewType, title });
