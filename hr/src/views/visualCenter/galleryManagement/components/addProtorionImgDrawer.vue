  ...
  <div v-if="isVisible">
    ...
    >
      ...
      <div class="form-wrapper promoteForm">
        ...
        >
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item label="测图目的" prop="mappingPurpose">
                <s-text-area
                  v-model="promoteForm.mappingPurpose"
                  placeholder="请输入测图目的"
                  :autosize="{ minRows: 4, maxRows: 4 }"
                />
              </el-form-item>
            ...
            <el-col :span="12">
              <el-form-item label="推广版本" prop="version">
                <div style="display: flex; color: #666">
                  ...
                  <!--                :disabled="promoteForm.type == '2'" -->
                  <el-input-number
                    v-if="!isView"
                    disabled
                    v-model="promoteForm.version"
                    :min="addForm.promotionImageMaxVersion + 1"
                    :max="addForm.promotionImageMaxVersion + 1"
                  />
                  <el-input-number
                    v-else
                    disabled
          ...
          <el-row>
            <el-col :span="12">
              ...
              >
                <el-input
                  v-model="promoteForm.clickRateSeven"
                  placeholder="7天付费点击率"
                  type="number"
                />
              </el-form-item>
          ...
          <el-row>
            <el-col :span="12">
              ...
              >
                <el-input
                  v-model="promoteForm.clickRateFifteen"
                  placeholder="15天付费点击率"
                  type="number"
                />
              </el-form-item>
            </el-col>
          ...
          <el-row>
            <el-col :span="12">
              ...
              >
                ...
                <el-select
                  v-else
                  v-model="promoteForm.conclusionType"
                  placeholder="请选择"
                  clearable
                >
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item label="车图" prop="imgs">
                <UploadImgs
                  :disabled="isView ? promoteForm.type == '2' : false"
                  :limit="999"
                  :bussiness-code="UPLOAD_FILE_BISSONESSCODE.PICTURE_GALLERY_PROMOTION"
                  v-model:modelValue="promoteForm.imgs"
                />
              </el-form-item>
            </el-col>
          </el-row>
        ...
        <img
          v-if="showInfoIndex === 0 && promoteInfoList.length > 1"
          class="arrow Left notAllow"
          :src="switch_arrow_left_Img"
        />
        <img
          v-if="showInfoIndex > 0 && promoteInfoList.length > 1"
          class="arrow Left"
          :src="switch_arrow_left_hlImg"
          @click="promotePreClick"
        />
        <img
          v-if="promoteInfoList.length > 1 && showInfoIndex < promoteInfoList.length - 1"
          class="arrow Right"
          :src="switch_arrow_right_hlImg"
          @click="promoteNextClick"
        />
        <img
          v-if="showInfoIndex === promoteInfoList.length - 1 && promoteInfoList.length > 1"
          class="arrow Right notAllow"
          :src="switch_arrow_rightImg"
        />
      </div>
...
const itemRules = computed(() => {
  ...
  return {
    ...
    imgs: [{ required: true, message: '请上传车图片', trigger: 'blur' }],
...
const submit = debounce(async () => {
  ...
  try {
    const data = {
      ...addForm.value,
      ...promoteForm.value,
      imageList: getPromotionImageList(promoteForm.value.imgs || []),
      imgs: undefined
    } as any
